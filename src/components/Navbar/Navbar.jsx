    ...
    <div className="flex items-center gap-4">
      ...
      >
        ...
        {!token ? (
          <>
            <li>
              <Link to="/login" className="text-md font-semibold transition-all capitalize px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-300 hover:text-black">
                Login
              </Link>
            </li>
            <li>
              <Link to="/register" className="text-md font-semibold transition-all capitalize px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-300 hover:text-black">
                Register
              </Link>
            </li>
          </>
          ...
          <>
            {/* إذا كان المستخدم مسجل دخول، أظهر جميع الروابط */}
            <li>
            ...
            {/* Orders Link */}
            <li>
              <Link to="/allorders" className={`relative text-md font-semibold transition-all capitalize px-3 py-2 rounded-lg ${location.pathname === "/allorders" ? "bg-gradient-to-r from-[#6D28D9] via-[#EC4899] to-[#a2a2a3] text-white" : "text-gray-600 hover:bg-gray-300 hover:text-black"}`}>
                Orders
              </Link>
            </li>

            {/* Icons (Wishlist, Cart, Menu) */}
            ...
            <li className="ml-4">
              <span
                className="block w-full text-md font-semibold text-white bg-gradient-to-r from-[#6D28D9] via-[#EC4899] to-[#a2a2a3] px-4 py-2 rounded-lg hover:opacity-90 cursor-pointer"
                onClick={logout}
              >
